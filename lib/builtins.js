...
const builtins = module.exports = {
    ...
    Numb: {
         ...
         */
        parse (value) {
            return isString(value) ? Number(value) : NaN;
        },
    ...
    Text: {
         ...
         */
        find: s1 => s2 => isString(s1) && isString(s2) ? s2.indexOf(s1) : NaN,
         ...
         *  - applies only on the first item if the parameter of `f` is a tuple
         */
        rfind: s1 => s2 => isString(s1) && isString(s2) ? s2.lastIndexOf(s1) : NaN,
         ...
         */
        lower: str => isString(str) ? str.toLowerCase() : undefined_text,
         ...
         *  If the parameter is a tuple, this function applies to its first item only.
         */
        upper: str => isString(str) ? str.toUpperCase() : undefined_text,
         ...
         *  If the parameter is a tuple, this function applies to its first item only.
         */
        trim: s => isString(s) ? s.trim() : undefined_text,
         ...
         *  If the parameter is a tuple, this function applies to its first item only.
         */
        trim_head: s => isString(s) ? s.trimStart() : undefined_text,
         ...
         *  If the parameter is a tuple, this function applies to its first item only.
         */
        trim_tail: s => isString(s) ? s.trimEnd() : undefined_text,
         ...
         *  - applies only on the first item if the parameter of `f` is a tuple
         */
        head: n => s => isNumber(n) && isString(s) ? s.slice(0,n) : undefined_text,
         ...
         *  - applies only on the first item if the parameter of `f` is a tuple
         */
        tail: n => s => isNumber(n) && isString(s) ? s.slice(n) : undefined_text,
         ...
         *  - applies only on the first item if the parameter of `f` is a tuple
         */
        split: s1 => s2 => isString(s1) && isString(s2) ? s2.split(s1) : undefined_text,             
    }
}
