...
F.str = async function (...args) {
    ...
    switch (type) {
        ...
        case "Namespace": return T.isFunction(val.__str__) ? await val.__str__(val) : `[[Namespace of ${names(val).length} items]]`;
