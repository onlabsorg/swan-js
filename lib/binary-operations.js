...
O.equal = T.defineBinaryOperation({
...
O.compare = T.defineBinaryOperation({
...
O.pair = T.defineBinaryOperation({
    "Anything,Anything" : (val1, val2) => T.createTuple(val1, val2)
});

O.apply = T.defineBinaryOperation({
...
O.compose = T.defineBinaryOperation({
