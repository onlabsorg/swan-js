...
class Parser {
    ...
    // Creates a binary operation ASTNode and eventually wraps it if the
    // options object contains a wrapper function.
    ...
    // Creates a unary operation ASTNode and eventually wraps it if the
    // options object contains a wrapper function.
    ...
    // Creates a grouping operation ASTNode and eventually wraps it if the
    // options object contains a wrapper function.
    ...
    // Creates a literal ASTNode and eventually wraps it if the
    // options object contains a wrapper function.
